...
- `residencyLine` is copied word for word, with its deadline, from the live https://voltaeffect.com/ai-residency page. If you cannot open that page, leave the idea out and tell the editor. Never write the line or the deadline from memory.
