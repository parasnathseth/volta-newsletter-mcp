# Sample issue: review notes

Newsletter date **2026-09-28**. Subject: **Volta: the AI Productivity Lab opens, and one idea to build**. Built by `scripts/build-sample-issue.mjs` from real sources on 2026-09-24. Nothing was sent and no Mailchimp account was touched.
